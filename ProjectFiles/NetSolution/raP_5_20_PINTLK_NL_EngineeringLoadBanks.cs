...
public class raP_5_20_PINTLK_NL_EngineeringLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks() 
    {
        ...
        const string LOGID = "Interlock Engineering: Load Banks"; // ID used for the error logs
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvEngList";  // Name of the list widget used when there are no banks
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvEngListBank";  // Name of bank widget
