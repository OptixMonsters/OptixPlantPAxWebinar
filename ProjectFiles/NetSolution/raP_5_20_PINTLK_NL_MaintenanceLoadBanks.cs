...
public class raP_5_20_PINTLK_NL_MaintenanceLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock Maintenance: Load Banks"; // ID used for the error logs
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_MaintList";  // Name of the list widget used when there are no banks
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_MaintListBank";  // Name of bank widget
