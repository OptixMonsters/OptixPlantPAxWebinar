...
public class raP_5_20_PINTLK_NL_HomeLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock Home: Load Banks"; // ID used for the error logs
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_HomeList";  // Name of the list widget used when there are no banks
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_HomeListBank";  // Name of bank widget
