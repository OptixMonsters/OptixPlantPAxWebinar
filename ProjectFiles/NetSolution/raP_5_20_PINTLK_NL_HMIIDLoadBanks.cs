...
public class raP_5_20_PINTLK_NL_HMIIDLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock HMI ID: Load Banks"; // ID used for the error logs
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMIId";  // Name of the list widget used when there are no banks
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMIIdBank";  // Name of bank widget
